...
const LOCALE = {
  ...
  en: {
    ...
    // Home
    home_title: 'University of Chile Meteorites',
    home_subtitle: 'National Meteorite Repository — Department of Geology',
    ...
    home_desc1: 'University of Chile Meteorites, the national meteorite repository of the Department of Geology, houses {count} meteorite specimens recovered from the Atacama Desert. It is a catalog of classifications produced by research works of Universidad de Chile students, integrating magnetic susceptibility data (KLY5-A Kappabridge) from the Paleomagnetism Laboratory (Universidad de Chile), infrared spectroscopy (FT-IR) from the Cosmic Dust Laboratory at Universidad Diego Portales, glassy melt inclusion studies, and petrography from the Planetary Fluids Laboratory (Department of Geology, Universidad de Chile).',
    home_desc2: 'Raman spectroscopy and X-ray diffraction (XRD) data will be progressively integrated, thanks to the new research grant "Infrared–Magnetic–Petrographic Classification of Atacama Ordinary Chondrites", which will produce the first integrated dataset linking laboratory infrared spectra with meteorite classification and astronomical observations (JWST-MIRI and VLTI-MATISSE). This project was funded by a Community Grant from the Meteoritical Society (August 2025) and is housed at the Departamento de Geología, Facultad de Ciencias Físicas y Matemáticas, Universidad de Chile.',
    ...
    contact_loan_desc: 'University of Chile Meteorites, the national meteorite repository of the Department of Geology, is a physical meteorite collection available to the scientific community.',
    ...
    research_desc: 'Research works associated with University of Chile Meteorites, the National Meteorite Repository of the Department of Geology.',
  ...
  es: {
    ...
    // Home
    home_title: 'Meteoritos Universidad de Chile',
    home_subtitle: 'Repositorio Nacional de Meteoritos — Departamento de Geología',
    ...
    home_desc1: 'Meteoritos Universidad de Chile, el Repositorio Nacional de Meteoritos del Departamento de Geología, alberga {count} especímenes de meteoritos recuperados del Desierto de Atacama. Es un catálogo de clasificaciones elaboradas a partir de trabajos de investigación de estudiantes de la Universidad de Chile, que integra datos de susceptibilidad magnética (KLY5-A Kappabridge) del Laboratorio de Paleomagnetismo (Universidad de Chile), espectroscopía infrarroja (FT-IR) del Laboratorio de Polvo Cósmico de la Universidad Diego Portales, estudios de inclusiones vítreas y petrografía del Laboratorio de Fluidos Planetarios (Departamento de Geología, Universidad de Chile).',
    home_desc2: 'Prontamente se integrarán datos de espectroscopía Raman y de difracción de rayos X (DRX), gracias a la nueva investigación "Infrared–Magnetic–Petrographic Classification of Atacama Ordinary Chondrites", que producirá el primer conjunto de datos integrado que vincula los espectros infrarrojos de laboratorio con la clasificación de meteoritos y las observaciones astronómicas (JWST-MIRI y VLTI-MATISSE). Este proyecto fue financiado por una Community Grant de la Meteoritical Society (agosto 2025) y está alojado en el Departamento de Geología, Facultad de Ciencias Físicas y Matemáticas, Universidad de Chile.',
    ...
    contact_loan_desc: 'Meteoritos Universidad de Chile, el Repositorio Nacional de Meteoritos del Departamento de Geología, es una colección física de meteoritos disponible para la comunidad científica.',
    ...
    research_desc: 'Trabajos de investigación asociados a Meteoritos Universidad de Chile, el Repositorio Nacional de Meteoritos del Departamento de Geología.',
